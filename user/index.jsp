    ...
    <div class="largeTable">
        <div class="dashboard-desktop">
            <div class=" dash-border z-depth-5">
                ...
                <div class="dashBoardValue">721</div>
            </div>
            <div class=" dash-border z-depth-5">
                <div class="dashboardHead">Visitors</div>
                <div class="dashBoardValue">4985</div>
            </div>
            <div class=" dash-border z-depth-5">
                <div class="dashboardHead">Blood Requests</div>
                <div class="dashBoardValue">61</div>
            </div>
        </div>
        <div class="dashboard-desktop">
            <div class=" dash-border z-depth-5">
            ...
            <div class=" dash-border z-depth-5">
                ...
                <div class="dashBoardValue">80</div>
            </div>
        </div>
